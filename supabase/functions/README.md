...
| Função                        | Estado                                                                         |
| ----------------------------- | ------------------------------------------------------------------------------ |
| `qr-resolve`                  | Implementada — token, validade FREE/PRO, dados do anúncio, link wa.me corretor |
...
| `media-process`               | Opcional — variantes async; upload web já marca mídia como `ready`             |
