...
| Admin (pré-existente staging) | `farollapi@gmail.com` | *(credencial de staging — não reproduzida neste relatório)* |
...
*Relatório gerado com base em execução real de Playwright e comandos locais; itens não executados estão marcados explicitamente.*
